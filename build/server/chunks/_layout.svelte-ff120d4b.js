import { c as create_ssr_component, g as get_store_value, v as validate_component, e as escape, a as add_attribute, b as compute_slots } from './index2-06aadbcb.js';
import { w as writable } from './index-0c137e7b.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(AppBar, "AppBar").$$render($$result, { slotTrail: "place-content-end" }, {}, {
    trail: () => {
      return `-`;
    }
  })}

<div class="container h-full mx-auto p-4 flex justify-center items-center"><div class="space-y-5">${slots.default ? slots.default({}) : ``}</div></div>`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-ff120d4b.js.map
